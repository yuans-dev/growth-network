...
const inviteSteps = [
  {
    ...
    detail: "A Growth Advisor pre-defines your account and sends an invite link.",
  },
  {
    title: "Sign in with invited email",
    detail: "Use the invited email from your advisor. Non-invited emails cannot self-register.",
  },
  {
    title: "Accept invite and consents",
    detail: "Complete the claim flow with PDPA-PH, NDA-light, and non-circumvention acceptance.",
  },
  {
    title: "Activate access",
    detail: "After claim, your account becomes active and you can access the member portal.",
  },
];
      ...
      <section className="border-b border-[var(--color-hairline)] bg-[var(--color-surface-soft)] px-[5%] py-12">
        <div className="mx-auto max-w-[1280px]">
          ...
          <p className="mt-2 text-[var(--color-body)]">
            Accounts are pre-provisioned by Growth Advisors. Self-signup is disabled.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[900px] space-y-6">
          {inviteSteps.map((step, index) => (
            ...
            >
              ...
              <h2 className="mt-2 text-xl font-600 text-[var(--color-ink)]">{step.title}</h2>
              <p className="mt-2 text-sm text-[var(--color-body)]">{step.detail}</p>
            </div>
          ))}

          <div className="rounded-lg border border-[var(--color-hairline)] bg-[var(--color-surface-soft)] p-6">
            <p className="text-sm text-[var(--color-body)]">
              If you already have an invited email, go to the home page and sign in to continue to invite claim.
            </p>
